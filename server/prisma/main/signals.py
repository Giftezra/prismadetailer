        ...
        if instance.status == 'accepted':
            ...
            if reminder_time > now and instance.primary_detailer:
                send_push_notification.apply_async(
                    args=[instance.primary_detailer.user.id, "Job Starting Soon! 🚗", f"Your {instance.service_type.name} appointment with {instance.client_name} starts in 30 minutes at {instance.address}", "reminder"],
                    eta=reminder_time
                )
                pass
